...
return function()
	...
	local Window = Library:CreateWindow({
		Title = timef("Scape Hub Premium Editor - %A, %B %d%o, %Y.", u0name),
		Center = true,
		AutoShow = true,
		TabPadding = 8,
		MenuFadeTime = 0
	...
	LeftGroupBox:AddToggle("Auto Parry Toggle", {
		Text = "Auto Parry "..emojies[math.random(1,#emojies)],
		Default = false,
